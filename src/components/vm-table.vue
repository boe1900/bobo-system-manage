  ...
  <Row class="vm-table vm-panel">
    ...
    <div class="panel-body">
      ...
      <Row type="flex" justify="space-between" class="footer">
        <div class="info-bar">
          Show<Input-number class="input-number" v-model="showNum" :max="total" :min="1" @on-change="updateDataShow(1) ">{{ showNum }}</Input-number>/ Page
        </div>
        <div class="page">
    ...
    export default {
        ...
        methods: {
            ...
            pageChange: function (page) {
                this.updateDataShow(page);
            },
            updateDataShow: function (page) {
                this.currentPage = page;
                this.$emit('page-change',{currentPage:page,showNum:this.showNum,keyword:this.keyword});
            },
            search: function () {
                let that = this;
